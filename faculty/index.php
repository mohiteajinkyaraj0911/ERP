...
<head>
    ...
    <title>Faculty Dashboard - PJC College ERP</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="welcome-section">
            ...
            <p>Welcome to your faculty dashboard. Manage your courses, attendance, and grades here.</p>
        </div>
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                <div class="icon">👥</div>
                <h3>Students</h3>
                <p>Manage enrolled students and attendance.</p>
            ...
            <div class="dashboard-card">
                <div class="icon">📊</div>
                <h3>Reports</h3>
                <p>View your performance reports.</p>
